(function ($) {
    ...
    function lazyVideo() {
        ...
        youtube.each(function () {
            ...
            $(this).on("click", "div.play-button", function (e) {
                var $video_iframe = $(
                    '<iframe class="embed-responsive-item" src="//www.youtube.com/embed/' + id + '?rel=0&showinfo=0&autoplay=1&output=embed" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'
                );
    ...
    $(function () {
        ...
        var ptPage = $(".subpages");
        if (ptPage[0]) {
            PageTransitions.init({ menu: "ul.site-auto-menu" });
        }
        headerHeight();
        ...
        $(".text-rotation").owlCarousel({ loop: !0, dots: !1, nav: !1, margin: 10, items: 1, autoplay: !0, autoplayHoverPause: !1, autoplayTimeout: 3800, animateOut: "zoomOut", animateIn: "zoomIn" });
        body.magnificPopup({
            fixedContentPos: !1,
            delegate: "a.lightbox",
            type: "image",
        ...
        // });
        $("body").append(
            '<div id="page-ajax-loaded" class="page-portfolio-loaded animated rotateInDownRight" style="display: none"><div class="portfolio-preloader"><div class="preloader-animation"><div class="preloader-spinner"></div></div></div></div>'
        );
        ajaxLoader();
        lazyVideo();
    });
...
var Formstone = (window.Formstone = (function (a, b, c) {
    ...
    var k = function () {
        (this.Version = "0.8.35"),
            ...
            (this.userAgent = b.navigator.userAgent || b.navigator.vendor || b.opera),
            ...
            return (
                (m.Plugins[c] = (function (c, d) {
                    ...
                    return (
                        ...
                        (d.functions = a.extend({ getData: h, iterate: q }, l, d.functions)),
                        (d.methods = a.extend(!0, { _setup: a.noop, _construct: a.noop, _postConstruct: a.noop, _destruct: a.noop, _resize: !1, destroy: g }, d.methods)),
                        (d.utilities = a.extend(!0, { _initialize: !1, _delegate: !1, defaults: n }, d.utilities)),
                        d.widget && ((m.Conflicts.fn[c] = a.fn[c]), (a.fn[s] = i), m.DontConflict || (a.fn[c] = a.fn[s])),
                        (m.Conflicts[c] = a[c]),
                        ...
                        (d.namespaceClean = s),
                        (d.guid = 0),
                        d.methods._resize && (m.ResizeHandlers.push({ namespace: c, priority: d.priority, callback: d.methods._resize }), m.ResizeHandlers.sort(j)),
                        d.methods._raf && (m.RAFHandlers.push({ namespace: c, priority: d.priority, callback: d.methods._raf }), m.RAFHandlers.sort(j)),
                        d
                    );
                })(c, f)),
                n.then(function () {
...
!(function (a, b) {
    ...
    function c(a, c) {
        if (c) {
            ...
            var d = a.$check.css(b.transition + "-duration"),
                f = parseFloat(d);
            b.support.transition && d && f
                ? this.on(k.transitionEnd, a, e)
                : (a.timer = l.startTimer(
                    a.timer,
                    50,
                    function () {
                        g(a);
    ...
    function i(b, c) {
        ...
        for (var d in b) if (!b.hasOwnProperty(d) || !c.hasOwnProperty(d) || b[d] !== c[d]) return !1;
        return !0;
    }
...
!(function (a, b) {
        ...
        if (c !== b.source) {
            ...
            if (((b.video = b.isYouTube || f), (b.playing = !1), b.isYouTube)) (b.playerReady = !1), (b.posterLoaded = !1), k(b, c, d);
                ...
                if ("object" === a.type(c)) {
                    ...
                    n.sort(y.sortAsc);
                    for (l in n) n.hasOwnProperty(l) && m.push({ width: parseInt(n[l]), url: c[n[l]], mq: window.matchMedia("(min-width: " + parseInt(n[l]) + "px)") });
    ...
    function i(b, c, d, e) {
        ...
        h
            .one(x.load, function () {
                B && g.addClass(w["native"]).css({ backgroundImage: "url('" + i + "')" }),
                    g
                        .fsTransition({ property: "opacity" }, function () {
                            d || l(b);
                        })
                        .css({ opacity: 1 }),
                    s(b),
                    (!d || e) && b.$el.trigger(x.loaded);
            })
            .attr("src", i),
            b.responsive && g.addClass(w.responsive),
            b.$container.append(g),
            (h[0].complete || 4 === h[0].readyState) && h.trigger(x.load),
            (b.currentSource = i);
    }
    function j(c, d, e) {
        if ((c.source && c.source.poster && (i(c, c.source.poster, !0, !0), (e = !1)), !b.isMobile)) {
            ...
            (g += "<video"),
                ...
                c.mute && (g += " muted"),
                (g += ">"),
                c.source.webm && (g += '<source src="' + c.source.webm + '" type="video/webm" />'),
            ...
            if ((a("script[src*='youtube.com/iframe_api']").length || a("head").append('<script src="//www.youtube.com/iframe_api"></script>'), C)) {
                ...
                var k = a(j),
                    m = a.extend(
                        !0,
                        {},
                        { controls: 0, rel: 0, showinfo: 0, wmode: "transparent", enablejsapi: 1, version: 3, playerapiid: g, loop: c.loop ? 1 : 0, autoplay: 1, origin: z.location.protocol + "//" + z.location.host },
                        c.youtubeOptions
                    );
                c.$container.append(k),
                    c.player && ((c.oldPlayer = c.player), (c.player = null)),
                    (c.player = new z.YT.Player(g, {
                        videoId: c.videoId,
                        playerVars: m,
                        events: {
                            onReady: function () {
                            ...
                            onStateChange: function (a) {
                                c.playing || a.data !== z.YT.PlayerState.PLAYING
                                    ? c.loop && c.playing && a.data === z.YT.PlayerState.ENDED && c.player.playVideo()
                                    : ((c.playing = !0),
                                        c.autoPlay || c.player.pauseVideo(),
                                        k
                                            .fsTransition({ property: "opacity" }, function () {
                                                l(c);
                                            })
                                        ...
                                        s(c),
                                        c.$el.trigger(x.loaded)),
                                    c.$el.find(v.embed).addClass(w.ready);
                            },
    ...
    function s(a) {
        for (var b = a.$container.find(v.media), c = 0, d = b.length; d > c; c++) {
            ...
            if (g.length && ("img" !== f || !B)) {
                ...
                (a.height = i),
                    (a.width = a.height * k),
                    a.width < h && ((a.width = h), (a.height = a.width / k)),
                    (a.left = -(a.width - h) / 2),
                    (a.top = -(a.height - i) / 2),
                    e.css({ height: a.height, width: a.width, left: a.left, top: a.top });
            }
        }
    }
    function t(b, c) {
        if (b.isYouTube) return { height: 500, width: 500 / b.embedRatio };
        if (c.is("img")) {
            var d = c[0];
            if ("undefined" !== a.type(d.naturalHeight)) return { height: d.naturalHeight, width: d.naturalWidth };
            var e = new Image();
    ...
    var u = b.Plugin("background", {
        widget: !0,
        defaults: { autoPlay: !0, customClass: "", embedRatio: 1.777777, loop: !0, mute: !0, source: null, youtubeOptions: {} },
        classes: ["container", "media", "animated", "responsive", "native", "fixed", "ready"],
        events: { loaded: "loaded", ready: "ready", loadedMetaData: "loadedmetadata" },
        methods: { _construct: e, _destruct: f, _resize: c, play: o, pause: n, mute: p, unmute: q, resize: s, load: g, unload: m },
    }),
        v = u.classes,
        w = v.raw,
        x = u.events,
    ...
    $(document).ready(function ($) {
        ...
        $(".testimonials").each(function () {
            var mobile_mode_items = $(this).attr("data-mobile-items"),
                ...
                id = $(this).attr("id");
            $("#" + id + ".testimonials.owl-carousel").owlCarousel({ nav: !0, items: 2, loop: !1, navText: !1, margin: 10, responsive: { 0: { items: mobile_mode_items }, 768: { items: tablet_mode_items }, 1200: { items: items } } });
        });
    });
})(jQuery);
