...
!(function (a) {
  ...
  return (
    (E.EventType = { LOADING: "loading", DONE: "done", LAYOUT: "layout", REMOVED: "removed" }),
    (E.ClassName = { BASE: u, SHUFFLE_ITEM: "shuffle-item", FILTERED: "filtered", CONCEALED: "concealed" }),
    (E.options = {
      group: v,
      speed: 250,
      easing: "ease-out",
    ...
    (E._getNumberStyle = function (b, c, d) {
      if (t) {
        ...
        return (
          B || "width" !== c
            ? B || "height" !== c || (e += E._getFloat(d.paddingTop) + E._getFloat(d.paddingBottom) + E._getFloat(d.borderTopWidth) + E._getFloat(d.borderBottomWidth))
            : (e += E._getFloat(d.paddingLeft) + E._getFloat(d.paddingRight) + E._getFloat(d.borderLeftWidth) + E._getFloat(d.borderRightWidth)),
          e
        );
      }
    ...
    (E.prototype._getColumnSize = function (b, c) {
      var d;
      return (
        (d = a.isFunction(this.columnWidth) ? this.columnWidth(b) : this.useSizer ? E._getOuterWidth(this.sizer) : this.columnWidth ? this.columnWidth : this.$items.length > 0 ? E._getOuterWidth(this.$items[0], !0) : b),
        0 === d && (d = b),
        d + c
      );
    }),
    ...
    (E.prototype._layoutItem = function (b, c) {
      var d = a(b),
        ...
        f = e.point,
        g = e.scale,
        h = { width: E._getOuterWidth(b, !0), height: E._getOuterHeight(b, !0) },
    ...
    (E.prototype._processStyleQueue = function (b) {
      ...
      f(
        ...
        c.length > 0 && this.initialized && this.speed > 0
          ? ((this.isTransitioning = !0), this.supported ? this._whenCollectionDone(c, o, this._movementFinished) : this._whenAnimationsDone(this._movementFinished))
    ...
    (E.prototype._cancelMovement = function () {
      this.supported
        ...
        : ((this._isMovementCanceled = !0), this.$items.stop(!0), (this._isMovementCanceled = !1)),
    ...
    (E.prototype.destroy = function () {
      D.off("." + this.unique),
        ...
        this.$items.removeAttr("style").removeData("point").removeData("scale").removeClass([E.ClassName.CONCEALED, E.ClassName.FILTERED, E.ClassName.SHUFFLE_ITEM].join(" ")),
        (this.$items = null),
        (this.$el = null),
        (this.sizer = null),
        (this.element = null),
...
(function ($, window, undefined) {
  ...
  $.HoverDir.defaults = { speed: 300, easing: "ease", hoverDelay: 0, inverse: !1 };
  $.HoverDir.prototype = {
    _init: function (options) {
      this.options = $.extend(!0, {}, $.HoverDir.defaults, options);
    ...
    _applyAnimation: function (el, styleCSS, speed) {
      ...
      el.stop().applyStyle(styleCSS, $.extend(!0, [], { duration: speed + "ms" }));
    },
  };
  ...
  (t.prototype = {
    ...
    open: function (c) {
      ...
      (b.types = []),
        ...
        b.bgOverlay ||
        ((b.bgOverlay = x("bg").on("click tap " + p, function () {
          b.close();
        })),
          (b.wrap = x("wrap")
            .attr("tabindex", -1)
            .on("click tap " + p, function (a) {
    ...
    updateStatus: function (a, d) {
      if (b.preloader) {
        ...
        y("UpdateStatus", e),
          ...
          (d = e.text),
          b.preloader.html(d),
          b.preloader.find("a").on("click tap", function (a) {
...
var PageTransitions = (function ($, options) {
  ...
  function Animate($pageTrigger, gotoPage) {
    ...
    if (currentPageId != gotoPage) {
      ...
      $currentPage.addClass(outClass).on(animEndEventName, function () {
        ...
        $currentPage.attr("class", "pt-page pt-page-" + $currentPage.data('id'));
  ...
  function init(options) {
    ...
    $(document).on('click tap', ".pt-trigger",function () {
    ...
    window.onpopstate = function (event) {
      if (location.hash) {
        if (NextAnimating == !0 || CurrentAnimating == !0) {
          return !1;
        }
    ...
    activeMenuItem(menuLink);
    Animate(menuLink);
    $(".app-arrow-right").on('click tap',function () {
    ...
    $(".app-arrow-left").on('click tap', function () {
      var activeItem = $(".site-main-menu li.active");
